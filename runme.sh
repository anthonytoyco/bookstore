...
# =============================================================================
# BOOKSTORE - BUILD, TEST & UML GENERATION SCRIPT
# =============================================================================
...
show_help() {
    echo "=============================================================================="
    echo "BOOKSTORE -  BUILD & TEST SCRIPT - USAGE GUIDE"
    echo "=============================================================================="
    echo ""
    echo "SYNOPSIS:"
    ...
    echo ""
    echo "DESCRIPTION:"
    echo "  This script performs a complete build cycle for the Bookstore project,"
...
show_version() {
    echo "=============================================================================="
    echo "BOOKSTORE -  BUILD & TEST SCRIPT"
    echo "=============================================================================="
    echo "Version: 2.0"
    echo "Author:  Anthony Toyco"
...
if [ $OVERALL_STATUS -eq 5 ]; then
    print_status "SUCCESS" "[SUCCESS] CONGRATULATIONS! Your project meets all requirements!"
