 ...
 * Provides a common interface for decorating materials with additional
 * features.
 * 
 * <p>
 * This class implements the Material interface and delegates all operations
 * to the wrapped material, allowing subclasses to override specific methods
 * to add new functionality without modifying the original material classes.
 * </p>
 * 
