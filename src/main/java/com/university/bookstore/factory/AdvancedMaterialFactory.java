...
/**
 * Enhanced factory for creating Material instances with advanced validation and
 * type-safe property extraction.
 * Demonstrates improved Factory pattern implementation with better error
 * handling and validation.
 * 
 * <p>
 * This factory extends the basic MaterialFactory with enhanced validation,
 * type-safe property extraction, and support for complex material
 * configurations.
 * </p>
 * 
...
public class AdvancedMaterialFactory {
    ...
    private static void validateEBookProperties(Map<String, Object> properties) {
        String[] required = { "id", "title", "author", "price", "year", "fileFormat", "fileSize", "drmEnabled",
                "wordCount", "quality" };
        validateRequiredKeys(properties, required);
    }

    private static void validateAudioBookProperties(Map<String, Object> properties) {
        String[] required = { "id", "title", "author", "narrator", "price", "year", "duration", "format", "fileSize",
                "quality", "language", "unabridged" };
        validateRequiredKeys(properties, required);
    }

    private static void validateVideoMaterialProperties(Map<String, Object> properties) {
        String[] required = { "id", "title", "director", "price", "year", "duration", "format", "fileSize", "quality",
                "videoType", "rating", "cast", "subtitlesAvailable", "aspectRatio" };
        validateRequiredKeys(properties, required);
    }
