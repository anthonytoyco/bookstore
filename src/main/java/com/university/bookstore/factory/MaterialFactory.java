 ...
 * 
 * <p>
 * This factory supports creating all material types including
 * the new EBook class, with proper validation and error handling.
 * </p>
 * 
...
public class MaterialFactory {
    ...
    private static String getRequiredString(Map<String, Object> properties, String key) {
        ...
        if (!(value instanceof String)) {
            throw new IllegalArgumentException(
                    "Property '" + key + "' must be a String, got: " + value.getClass().getSimpleName());
        }
    ...
    private static double getRequiredDouble(Map<String, Object> properties, String key) {
        ...
        throw new IllegalArgumentException(
                "Property '" + key + "' must be a number, got: " + value.getClass().getSimpleName());
    }
    ...
    private static int getRequiredInteger(Map<String, Object> properties, String key) {
        ...
        throw new IllegalArgumentException(
                "Property '" + key + "' must be an integer, got: " + value.getClass().getSimpleName());
    }
    ...
    private static boolean getRequiredBoolean(Map<String, Object> properties, String key) {
        ...
        throw new IllegalArgumentException(
                "Property '" + key + "' must be a boolean, got: " + value.getClass().getSimpleName());
    }
    ...
    private static Media.MediaQuality getRequiredMediaQuality(Map<String, Object> properties, String key) {
        ...
        if (value instanceof String) {
            try {
                ...
                throw new IllegalArgumentException(
                        "Property '" + key + "' must be a valid MediaQuality, got: " + value);
            }
        }
        throw new IllegalArgumentException(
                "Property '" + key + "' must be a MediaQuality, got: " + value.getClass().getSimpleName());
    }
    ...
    private static VideoMaterial.VideoType getRequiredVideoType(Map<String, Object> properties, String key) {
        ...
        throw new IllegalArgumentException(
                "Property '" + key + "' must be a VideoType, got: " + value.getClass().getSimpleName());
    }
    ...
    private static java.util.List<String> getOptionalStringList(Map<String, Object> properties, String key) {
        ...
        throw new IllegalArgumentException(
                "Property '" + key + "' must be a List<String> or String, got: " + value.getClass().getSimpleName());
    }
}
