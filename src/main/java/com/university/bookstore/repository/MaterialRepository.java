 ...
 * Defines the contract for material storage without specifying implementation
 * details.
 * 
 * <p>
 * This interface represents the "port" in the ports and adapters pattern,
 * allowing the domain layer to interact with persistence without being coupled
 * to specific storage technologies (JSON, database, etc.).
 * </p>
 * 
