...
/**
 * JSON-based implementation of MaterialRepository (Adapter in hexagonal
 * architecture).
 * Persists materials to a JSON file using Jackson for serialization.
 * 
 * <p>
 * This adapter implements the MaterialRepository port, providing JSON
 * file-based
 * persistence without the domain layer knowing about the storage mechanism.
 * </p>
 * 
