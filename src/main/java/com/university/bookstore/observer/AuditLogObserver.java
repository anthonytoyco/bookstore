 ...
 * Provides a complete history of system activities for compliance and
 * debugging.
 * 
...
public class AuditLogObserver implements MaterialObserver {
    ...
    public static class AuditLogStats {
        ...
        /**
         * Gets the number of material added events. @return number of material added
         * events
         */
        public int getMaterialAddedCount() {
            return materialAddedCount;
        }

        /**
         * Gets the number of price changed events. @return number of price changed
         * events
         */
