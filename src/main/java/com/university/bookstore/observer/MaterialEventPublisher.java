...
/**
 * Concrete implementation of MaterialSubject that publishes material events to
 * observers.
 * Provides thread-safe event publishing and observer management.
 * 
 * <p>
 * This class demonstrates the Observer pattern by managing a list of observers
 * and broadcasting events to all registered observers when material events
 * occur.
 * </p>
 * 
