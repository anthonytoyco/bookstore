 ...
 * Implements both Material and Media interfaces to demonstrate multiple
 * inheritance.
 * 
...
public class VideoMaterial extends Material implements Media {
    ...
    public String toString() {
        return String.format(
                "VideoMaterial[ID=%s, Title='%s', Director='%s', Type=%s, Duration=%dmin, Quality=%s, Rating=%s, Price=$%.2f]",
