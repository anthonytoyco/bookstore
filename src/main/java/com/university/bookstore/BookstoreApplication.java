 ...
 * 
 * <p>
 * This class demonstrates how the existing design can be easily extended
 * with Spring Boot to provide REST API capabilities without modifying the
 * core business logic or existing implementations.
 * </p>
 * 
 * <p>
 * The application leverages the existing MaterialStore interface and
...
public class BookstoreApplication {
    ...
    /**
     * Configures the MaterialStore bean using the existing
