 ...
 * 
 * <p>
 * Represents both individual materials and composite bundles uniformly. The
 * Composite Pattern is a structural design
 * pattern that allows developers to treat individual objects and groups of
 * objects uniformly. This is particularly
 * useful when working with tree-like structures, where both leaf objects (e.g.,
 * individual books) and composite
 * objects (e.g., bundles of books) need to share the same interface.
 * </p>
 * 
 * <p>
 * The pattern promotes the principle of "compose objects into tree structures
 * to represent part-whole hierarchies."
 * With Composite, clients can operate on single objects and entire compositions
 * through a common interface,
 * simplifying the design and improving extensibility.
 * </p>
 * 
 * <p>
 * This interface allows clients to treat individual materials and material
 * bundles uniformly, enabling
 * recursive composition and polymorphic operations.
 * </p>
 * 
 * <p>
 * Example usage:
