 ...
 * 
 * <p>
 * These tests demonstrate how the existing MaterialStore interface
 * can be easily tested through REST endpoints, showcasing the
 * extensibility of the hexagonal architecture design.
 * </p>
 * 
 * <p>
 * The tests verify that all CRUD operations work correctly through
 * the REST API without modifying the core business logic.
 * </p>
 * 
