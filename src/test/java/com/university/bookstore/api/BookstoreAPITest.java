...
class BookstoreAPITest {
    ...
    void testAddBook() {
        ...
        Book duplicate = new Book("9781234567890", "Different Title", "Different Author", 39.99, 2025);
    ...
    void testGetMostRecent() {
        ...
        Book recent = new Book("9781111111111", "Recent", "Author", 49.99, 2025);
        ...
        assertEquals(2025, mostRecent.getYear());
    }
    ...
    void testCompleteWorkflow() {
        ...
        bookstore.add(new Book("9781111111111", "JavaScript Pro", "Bob Johnson", 55.99, 2025));
