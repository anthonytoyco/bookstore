...
public class MaterialPolymorphismTest {
    ...
    void testPrintedBookValidation() {
        assertThrows(NullPointerException.class, () -> new PrintedBook(null, "Title", "Author", 10.0, 2020));

        assertThrows(IllegalArgumentException.class, () -> new PrintedBook("invalid", "Title", "Author", 10.0, 2020));
    ...
    void testVideoMaterialValidation() {
        ...
        // Remove this test since VideoMaterial might not validate ID length the same
        // way
    ...
    void testMagazineValidationAndFunctionality() {
        assertThrows(NullPointerException.class,
                () -> new Magazine(null, "Title", "Publisher", 6.99, 2025, 3, "Monthly", "Science"));

        assertThrows(IllegalArgumentException.class,
                () -> new Magazine("123", "Title", "Publisher", 6.99, 2025, 3, "Monthly", "Science"));

        assertThrows(IllegalArgumentException.class,
                () -> new Magazine("12345678", "Title", "Publisher", 6.99, 2025, 0, "Monthly", "Science"));
