...
public class ModernConcurrentMaterialStoreTest {
    ...
    void testAsyncAddMaterial() throws Exception {
        EBook ebook = new EBook("E001", "Async Java", "Author", 29.99, 2025,
    ...
    void testBatchAddMaterials() throws Exception {
        List<Material> materials = Arrays.asList(
                new PrintedBook("9781234567890", "Book 1", "Author 1", 19.99, 2025, 200, "ABC", true),
                new PrintedBook("9789876543210", "Book 2", "Author 2", 24.99, 2025, 300, "XYZ", false),
                new EBook("E001", "EBook 1", "Author 3", 14.99, 2025, "PDF", 1.5, true, 50, Media.MediaQuality.HIGH));
    ...
    void testAsyncFindById() throws Exception {
        PrintedBook book = new PrintedBook("9781234567890", "Test Book", "Author", 29.99, 2025, 300, "Publisher", true);
    ...
    void testAsyncSearchByTitle() throws Exception {
        store.addMaterial(
                new PrintedBook("9781234567890", "Java Programming", "Author 1", 39.99, 2025, 400, "Pub1", true));
        store.addMaterial(
                new PrintedBook("9789876543210", "Python Programming", "Author 2", 34.99, 2025, 350, "Pub2", false));
        store.addMaterial(new EBook("E001", "Java Concurrency", "Author 3", 29.99, 2025, "PDF", 2.0, false, 80,
    ...
    void testAsyncInventoryStats() throws Exception {
        // Add test materials
        for (int i = 0; i < 10; i++) {
            store.addMaterial(new PrintedBook("978123456" + String.format("%04d", i), "Book " + i, "Author", 20.0 + i,
                    2025, 200, "Publisher", i % 2 == 0));
        }

        CompletableFuture<com.university.bookstore.api.MaterialStore.InventoryStats> future = store
    ...
    void testParallelSearch() throws Exception {
        ...
        store.addMaterial(
                new PrintedBook("9781234567890", "Java Book", "John Doe", 39.99, 2025, 400, "Publisher", true));
        store.addMaterial(new EBook("E001", "Python Guide", "Jane Smith", 29.99, 2025, "PDF", 2.0, false, 100,
                Media.MediaQuality.HIGH));
        store.addMaterial(new AudioBook("9780123456789", "Audio Learning", "John Doe", "Narrator", 19.99, 2025, 180,
                "MP3", 5.0, Media.MediaQuality.STANDARD, "English", true));
                ...
                try {
                    for (int j = 0; j < operationsPerThread; j++) {
                        ...
                        PrintedBook book = new PrintedBook(
                                "978" + String.format("%010d", threadId * 1000 + j), "Book " + id, "Author", 29.99,
                                2025, 200, "Publisher", true);
    ...
    void testOptimisticReadPerformance() {
        ...
        for (int i = 0; i < 1000; i++) {
            store.addMaterial(new PrintedBook("978123456" + String.format("%04d", i), "Book " + i, "Author", 29.99,
                    2025, 200, "Publisher", true));
        }
    ...
    void testMultipleAsyncOperations() throws Exception {
        ...
        CompletableFuture<Boolean> addFuture1 = store.addMaterialAsync(
                new PrintedBook("9781234567890", "Book 1", "Author", 29.99, 2025, 200, "Publisher", true));

        CompletableFuture<Boolean> addFuture2 = store.addMaterialAsync(
                new EBook("E001", "EBook 1", "Author", 19.99, 2025, "PDF", 1.5, false, 50, Media.MediaQuality.HIGH));
    ...
    void testFindByIdsAsync() throws Exception {
        ...
        List<String> ids = Arrays.asList("9781234560000", "9781234560002", "9781234560004", "9999999999999"); // last
                                                                                                              // one
                                                                                                              // doesn't
                                                                                                              // exist
    ...
    void testResourceCleanup() throws Exception {
        ...
        tempStore.addMaterial(new PrintedBook("9781234567890", "Book", "Author", 29.99, 2025, 200, "Publisher", true));
        ...
        assertThrows(IllegalStateException.class, () -> tempStore.addMaterial(
                new PrintedBook("9789876543210", "Book 2", "Author", 29.99, 2025, 200, "Publisher", true)));
    }

    @Test
    @DisplayName("Test total inventory value async")
    void testGetTotalInventoryValueAsync() throws Exception {
        store.addMaterial(new PrintedBook("9781234567890", "Book 1", "Author", 20.00, 2025, 200, "Publisher", true));
        store.addMaterial(new PrintedBook("9789876543210", "Book 2", "Author", 30.00, 2025, 300, "Publisher", false));
        store.addMaterial(
                new EBook("E001", "EBook", "Author", 15.00, 2025, "PDF", 1.0, true, 50, Media.MediaQuality.HIGH));
