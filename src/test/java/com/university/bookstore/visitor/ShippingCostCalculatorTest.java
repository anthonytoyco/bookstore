...
class ShippingCostCalculatorTest {
    ...
    void setUp() {
        ...
        magazine = new Magazine("1234-5678", "Tech Magazine", "Tech Publisher",
                9.99, 2025, 1, "Monthly", "Technology");
    ...
    void testUnknownMaterialType() {
        ...
        assertThrows(IllegalArgumentException.class, () -> calculator.calculateShippingCost(unknownMaterial));
    }
    ...
    private static class MaterialCounter implements MaterialVisitor {
        ...
        public int getPrintedBookCount() {
