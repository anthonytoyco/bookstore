...
/**
 * Property-based tests using JUnit QuickCheck for the Bookstore Management
 * System.
 * Tests properties that should hold for all valid inputs, not just specific
 * examples.
 * 
 * <p>
 * These tests verify that certain invariants and properties are maintained
 * across a wide range of inputs, providing stronger guarantees than traditional
 * unit tests.
 * </p>
 * 
...
public class PropertyBasedTests {
    ...
    public void testBundlePricingProperty(
        ...
        com.university.bookstore.composite.MaterialBundle bundle = new com.university.bookstore.composite.MaterialBundle(
        ...
        // Property: Bundle discounted price should be less than or equal to original
        // price
    ...
    public void testDecoratorProperty(
        ...
        com.university.bookstore.decorator.GiftWrappingDecorator decorated = new com.university.bookstore.decorator.GiftWrappingDecorator(
                baseMaterial, wrappingStyle);
